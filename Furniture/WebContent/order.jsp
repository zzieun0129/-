...
<div class="form-horizontal">
        ...
        <div class="col-sm-6">
          <input class="form-control" id="inputId" type="email" placeholder="이름">
        </div>
        </div>
        ...
        <div class="col-sm-6">
          <input class="form-control" id="inputId" type="email" placeholder="핸드폰번호">
        </div>
        </div>
        ...
        <div class="col-sm-6">
          <input class="form-control" id="inputId" type="email" placeholder="받으시는 분">
        </div>
        </div>
        ...
        <div class="col-sm-6">
          <input class="form-control" id="inputId" type="email" placeholder="전화번호">
        </div>
        </div>
        <div class="form-group">
          <label class="col-sm-2 control-label" for="inputId">배송지주소</label>
        <div class="col-sm-6">
          <input class="form-control" id="inputId" type="email" placeholder="우편번호">
		<input class="form-control" id="inputId" type="email" placeholder="기본주소">
		<input class="form-control" id="inputId" type="email" placeholder="상세주소">
        ...
        <div class="col-sm-6">
          <input class="form-control" id="inputId" type="email" placeholder="배송요청사항">
        </div>
        </div>
     ...
     <input  type="radio" name="pay.payMnCd" id="rdPay01" value="CREDT_CARD_PAY">무통장입금
        
        </div>
        
        <div class="form-group">
          <h3 class="col-sm-2 control-label" for="inputId">600,000</h2>
        <div class="col-sm-6">
